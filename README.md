[![Build Status](https://travis-ci.org/BenbachirAzzedine/js-training.svg?branch=master)](https://travis-ci.org/BenbachirAzzedine/js-training)
## Setup
First, [**fork**](https://github.com/BenbachirAzzedine/js-training/fork?fragment=1) this repository.
